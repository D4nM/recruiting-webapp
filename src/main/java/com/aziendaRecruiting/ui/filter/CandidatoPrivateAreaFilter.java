...
@WebFilter("/jsp/private/candidato/*")
public class CandidatoPrivateAreaFilter implements Filter {

	@Override
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {

		System.out.println("Filtro d'accesso AREA PRIVATA CANDIDATO attivato");
		...
		try {
			...
			if(loggedUser == null) {
				...
				System.out.println("In CandidatoPrivateAreaFilter: currentUser è null");
