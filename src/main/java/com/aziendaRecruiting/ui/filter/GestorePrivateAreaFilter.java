...
@WebFilter("/jsp/private/gestore/*")
public class GestorePrivateAreaFilter implements Filter {

	@Override
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {

		System.out.println("Filtro d'accesso AREA PRIVATA GESTORE attivato");
		...
		try {
			...
			if(loggedUser == null) {
				...
				System.out.println("In GestorePrivateAreaFilter: currentUser è null");
