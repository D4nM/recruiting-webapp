...
@WebFilter("/jsp/private/azienda/*")
public class AziendaPrivateAreaFilter implements Filter {
	
	@Override
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {

		System.out.println("Filtro d'accesso AREA PRIVATA AZIENDA attivato");
		...
		try {
			...
			if(loggedUser == null) {
				...
				System.out.println("In AziendaPrivateAreaFilter: currentUser è null");
